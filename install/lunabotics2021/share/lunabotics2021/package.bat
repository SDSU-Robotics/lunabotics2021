...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\lunabotics2021\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/lunabotics2021/local_setup.bat"
