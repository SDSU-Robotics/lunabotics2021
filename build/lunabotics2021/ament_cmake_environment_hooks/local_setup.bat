...
set "AMENT_ENVIRONMENT_HOOKS[lunabotics2021]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[lunabotics2021] "%AMENT_CURRENT_PREFIX%\share\lunabotics2021\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[lunabotics2021] "%AMENT_CURRENT_PREFIX%\share\lunabotics2021\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[lunabotics2021]:;=";"%") do (
    call:call_file %%f
  )
